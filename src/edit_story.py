...
def main():
    ...
    side_buttons = (
        tk.Button(frm_btns_side, text="Italic", command=lambda: format_text(SimpleNamespace(keysym="i"))),
        tk.Button(frm_btns_side, text="Bold", command=lambda: format_text(SimpleNamespace(keysym="b"))),
