...
class Editor:
    ...
    def __init__(self) -> None:
        ...
        root.bind("<Alt-x>", text_box_en.char_convert)
        root.bind("<Control-BackSpace>", text_box_en.del_word)
        root.bind("<Control-Shift-BackSpace>", text_box_en.del_word)
        root.bind("<Control-Delete>", text_box_en.del_word)
        root.bind("<Control-Shift-Delete>", text_box_en.del_word)
