...
def createDict():
    ...
    names['かつての同級生'] = "Former Classmate"
    ...
    names['ラーメン屋店員'] = "Ramen Stall Assistant"
    names['ラーメン屋の店主'] = "Ramen Stallkeeper"
    names['パン屋さん'] = "Baker"
    names['店主'] = "Shopkeeper"
    ...
    names['選抜レース係員'] = "Selection Race Official"
    names['選抜レース係員A'] = "Selection Race Official A"
    names['選抜レース係員B'] = "Selection Race Official B"
    names['レース係員'] = "Race Official"
    names['宇宙人'] = "Alien"
    names['2人'] = "Both"
    names['3人'] = "All 3"
    names['4人'] = "All 4"
